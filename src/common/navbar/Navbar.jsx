...
//             {/* MOBILE MENU ICON */}
//             <button
//               className=" text-3xl cursor-pointer text-[#309255]"
    ...
    >
      <div className="flex flex-col">
        ...
        <div className="flex justify-between items-center">
          ...
          <div>
            <Link to="/">
              <span className="font-bold text-2xl">Darreb</span>{" "}
              <span className="font-bold text-2xl text-green-700">Academy</span>
            </Link>
          </div>
          ...
          <div className="hidden lg:flex gap-5 items-center text-lg activeLink">
            ...
            <NavLink to="courses" className="relative hover:text-[#309255] duration-400">
              {t(navLinks[1])}
            </NavLink>

            <NavLink to="/about" className="relative hover:text-[#309255] duration-400">
              {t(navLinks[2])}
            </NavLink>

            <NavLink to="/contact" className="relative hover:text-[#309255] duration-400">
              {t(navLinks[4])}
            </NavLink>
          ...
          <div className="flex gap-4 items-center">
            ...
            {!isLoggedIn ? (
              <div className="hidden lg:flex gap-3 items-center text-lg">
                <NavLink to="/signin" className="relative hover:text-[#309255] duration-400">
                  {t(navLinks[5])}
                </NavLink>
              ...
              <div className="hidden lg:flex relative items-center space-x-3">
                {isLoggedIn && userData && (
                  <button
                    type="button"
                    onClick={() => setUserMenuOpen(!userMenuOpen)}
                ...
                {userMenuOpen && userData && (
                  <div className="absolute end-0 top-full mt-2 z-50 w-44 bg-white border rounded shadow-lg border-[#ddd]">
                    <div className="px-4 py-3 text-sm border-b border-[#ddd]">
                      <span className="block font-medium">{userData.fullName}</span>
                      <span className="block text-gray-500 truncate">{userData.email}</span>
                    </div>
                    <ul className="p-2 text-sm">
                      <li className="p-2 hover:bg-gray-100 rounded cursor-pointer">
                        <NavLink
        ...
        {/* Mobile Menu - NOW PROPERLY POSITIONED */}
        {mobileOpen && (
          <div className="lg:hidden mt-6 flex flex-col gap-4 text-lg">
            <NavLink
              to="/"
            ...
            {!isLoggedIn ? (
              <>
                ...
                <Link
                  to="/signup"
                  className="py-3 px-7 border border-main rounded hover:bg-[#309255] hover:text-white duration-300 text-center"
                  onClick={() => setMobileOpen(false)}
                >
                  {t(navLinks[6])}
                </Link>
              ...
              <>
                ...
                <button
                  className="py-3 px-7 border border-red-500 text-red-500 rounded hover:bg-red-500 hover:text-white duration-300 text-center"
                  onClick={() => {
                    handleLogout();
                    setMobileOpen(false);
                  }}
